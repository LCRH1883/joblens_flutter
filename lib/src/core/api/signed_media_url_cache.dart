...
class SignedMediaUrlCache {
  SignedMediaUrlCache({Duration? defaultTtl, Duration? safetyMargin})
  ...
  String _cacheKey(String assetId, SignedMediaUrlKind kind) =>
      '$assetId:${kind.name}';
}
